...
#ifndef LIFTOFF_UTILS__SRV__DETAIL__TARGET_NAVIGATION__FUNCTIONS_H_
#define LIFTOFF_UTILS__SRV__DETAIL__TARGET_NAVIGATION__FUNCTIONS_H_
...
/// Initialize srv/TargetNavigation message.
/**
...
/// Finalize srv/TargetNavigation message.
/**
...
/// Create srv/TargetNavigation message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * liftoff_utils__srv__TargetNavigation_Request__init().
...
/// Destroy srv/TargetNavigation message.
/**
 * It calls
 * liftoff_utils__srv__TargetNavigation_Request__fini()
...
/// Check for srv/TargetNavigation message equality.
/**
...
/// Copy a srv/TargetNavigation message.
/**
...
/// Initialize array of srv/TargetNavigation messages.
/**
...
/// Finalize array of srv/TargetNavigation messages.
/**
 * It calls
 * liftoff_utils__srv__TargetNavigation_Request__fini()
...
/// Create array of srv/TargetNavigation messages.
/**
 * It allocates the memory for the array and calls
 * liftoff_utils__srv__TargetNavigation_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/TargetNavigation messages.
/**
 * It calls
 * liftoff_utils__srv__TargetNavigation_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/TargetNavigation message array equality.
/**
...
/// Copy an array of srv/TargetNavigation messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * liftoff_utils__srv__TargetNavigation_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_liftoff_utils
...
/**
 * It calls
 * liftoff_utils__srv__TargetNavigation_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_liftoff_utils
...
/**
 * It allocates the memory for the array and calls
 * liftoff_utils__srv__TargetNavigation_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_liftoff_utils
...
/**
 * It calls
 * liftoff_utils__srv__TargetNavigation_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // LIFTOFF_UTILS__SRV__DETAIL__TARGET_NAVIGATION__FUNCTIONS_H_
