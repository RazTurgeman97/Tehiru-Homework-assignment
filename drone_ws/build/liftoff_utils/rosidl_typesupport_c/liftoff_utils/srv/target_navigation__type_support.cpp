...
static const _TargetNavigation_Request_type_support_symbol_names_t _TargetNavigation_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, liftoff_utils, srv, TargetNavigation_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, liftoff_utils, srv, TargetNavigation_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, liftoff_utils, srv, TargetNavigation_Request)() {
  return &::liftoff_utils::srv::rosidl_typesupport_c::TargetNavigation_Request_message_type_support_handle;
}
...
static const _TargetNavigation_Response_type_support_symbol_names_t _TargetNavigation_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, liftoff_utils, srv, TargetNavigation_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, liftoff_utils, srv, TargetNavigation_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, liftoff_utils, srv, TargetNavigation_Response)() {
  return &::liftoff_utils::srv::rosidl_typesupport_c::TargetNavigation_Response_message_type_support_handle;
}
...
static const _TargetNavigation_type_support_symbol_names_t _TargetNavigation_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, liftoff_utils, srv, TargetNavigation)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, liftoff_utils, srv, TargetNavigation)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, liftoff_utils, srv, TargetNavigation)() {
  return &::liftoff_utils::srv::rosidl_typesupport_c::TargetNavigation_service_type_support_handle;
}
