...
#include "liftoff_utils/srv/detail/target_navigation__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = liftoff_utils::srv::TargetNavigation_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const liftoff_utils::srv::TargetNavigation_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<liftoff_utils::srv::TargetNavigation_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _TargetNavigation_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const liftoff_utils::srv::TargetNavigation_Request *>(
...
static size_t _TargetNavigation_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_TargetNavigation_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _TargetNavigation_Request__callbacks = {
  "liftoff_utils::srv",
...
static rosidl_message_type_support_t _TargetNavigation_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_TargetNavigation_Request__callbacks,
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_liftoff_utils
const rosidl_message_type_support_t *
get_message_type_support_handle<liftoff_utils::srv::TargetNavigation_Request>()
{
  return &liftoff_utils::srv::typesupport_fastrtps_cpp::_TargetNavigation_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = liftoff_utils::srv::TargetNavigation_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const liftoff_utils::srv::TargetNavigation_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<liftoff_utils::srv::TargetNavigation_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _TargetNavigation_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const liftoff_utils::srv::TargetNavigation_Response *>(
...
static size_t _TargetNavigation_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_TargetNavigation_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _TargetNavigation_Response__callbacks = {
  "liftoff_utils::srv",
...
static rosidl_message_type_support_t _TargetNavigation_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_TargetNavigation_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &liftoff_utils::srv::typesupport_fastrtps_cpp::_TargetNavigation_Response__handle;
}
...
static service_type_support_callbacks_t _TargetNavigation__callbacks = {
  "liftoff_utils::srv",
  "TargetNavigation",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, liftoff_utils, srv, TargetNavigation_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, liftoff_utils, srv, TargetNavigation_Response)(),
...
static rosidl_service_type_support_t _TargetNavigation__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_TargetNavigation__callbacks,
...
{
  return &liftoff_utils::srv::typesupport_fastrtps_cpp::_TargetNavigation__handle;
}
