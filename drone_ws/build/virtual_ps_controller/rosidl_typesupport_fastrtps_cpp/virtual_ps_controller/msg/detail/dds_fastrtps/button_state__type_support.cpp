...
#include "virtual_ps_controller/msg/detail/button_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const virtual_ps_controller::msg::ButtonState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  virtual_ps_controller::msg::ButtonState & ros_message)
{
  // Member: button_id
  cdr >> ros_message.button_id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = virtual_ps_controller::msg::ButtonState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const virtual_ps_controller::msg::ButtonState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<virtual_ps_controller::msg::ButtonState *>(
    untyped_ros_message);
...
{
  return &virtual_ps_controller::msg::typesupport_fastrtps_cpp::_ButtonState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, virtual_ps_controller, msg, ButtonState)() {
  return &virtual_ps_controller::msg::typesupport_fastrtps_cpp::_ButtonState__handle;
}
