    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'virtual_ps_controller.msg.ControllerState')
            logger.debug(
            ...
            from virtual_ps_controller.msg import ButtonState
...
class ControllerState(metaclass=Metaclass_ControllerState):
    ...
    _fields_and_field_types = {
        ...
        'buttons': 'sequence<virtual_ps_controller/ButtonState>',
        'axes': 'sequence<float>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['std_msgs', 'msg'], 'Header'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['virtual_ps_controller', 'msg'], 'ButtonState')),  # noqa: E501
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, ButtonState) for v in value) and
                 True), \
                "The 'buttons' field must be a set or sequence and each value of type 'ButtonState'"
        self._buttons = value
