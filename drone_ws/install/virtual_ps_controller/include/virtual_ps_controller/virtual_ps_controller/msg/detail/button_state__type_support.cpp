...
{
  new (message_memory) virtual_ps_controller::msg::ButtonState(_init);
}

void ButtonState_fini_function(void * message_memory)
{
  auto typed_message = static_cast<virtual_ps_controller::msg::ButtonState *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ButtonState_message_member_array[2] = {
  {
    ...
    offsetof(virtual_ps_controller::msg::ButtonState, button_id),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(virtual_ps_controller::msg::ButtonState, pressed),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ButtonState_message_members = {
  ...
  2,  // number of fields
  sizeof(virtual_ps_controller::msg::ButtonState),
...
get_message_type_support_handle<virtual_ps_controller::msg::ButtonState>()
{
  return &::virtual_ps_controller::msg::rosidl_typesupport_introspection_cpp::ButtonState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, virtual_ps_controller, msg, ButtonState)() {
  return &::virtual_ps_controller::msg::rosidl_typesupport_introspection_cpp::ButtonState_message_type_support_handle;
}
